...
const Register = () => {
    ...
    const register=function(e){
         ...
         console.log(role,name,email,number,pin);
                        ...
                        <div className="grid grid-cols-6 gap-4 col-span-full ">
                            ...
                            <div className="col-span-3">
                                <label className="input input-bordered flex items-center gap-2">
                                    ...
                                    <input type="number" name="number" className="grow" placeholder="Enter your mobile number" />
                                </label>
                            </div>
                            ...
                            <div className="col-span-3">
                                <label className="input input-bordered flex items-center gap-2">
                                    ...
                                    <input name="pin" type="password" className="grow" placeholder="Enter your pin number" />
                                </label>
                            </div>
